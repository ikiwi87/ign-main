...
<div class="page-content fade-in-up">
    <div class="ibox">
        <div class="ibox-head">
            ...
            <a class="btn btn-success" href="{{ route('export_students') }}"><i class="fa fa-download fa-fw"></i>
                Export list</a>
        </div>
                ...
                {{-- <tbody>
                    @if (count($students) > 0)
                        @foreach ($students as $student)
                            ...
                            <td>{{ $student->chuong_trinh }}</td>
                            <td>{{ $student->email }}</td>
                            <td>{{ $student->name_cha }}</td>
                            <td>{{ $student->phone_cha }}</td>
                            <td>{{ $student->act_deposit }}</td>
                            <td><a href="admin/students/edit/{{ $student->id }}" btn><i class="fa fa-edit"></i></a></td>
                        @endforeach
                    @else
                    @endif
