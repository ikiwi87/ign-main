...
<div class="col-md-12">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Add Dutrainghiem</div>
        ...
        <div class="ibox-body">
            <form method="post" action="{{route('dutrainghiem_admin_store')}}" class="text-left" accept-charset="utf-8" id="registerform">
                {{ csrf_field() }}
                <div class="row">
                ...
                <div class="form-group">
                    <div class="col-sm-12 text-right">
                        <button type="submit" class="btn btn-primary" id="btnRegister">CREATE</button>
                    </div>
                </div>
            </form>
        </div>
