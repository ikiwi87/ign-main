...
<div class="col-md-12">
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Add new school</div>
        ...
        <div class="ibox-body">
            <form action="{{route('school_store')}}" method="post" enctype="multipart/form-data" class="form-horizontal"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="district_id" class="form-control" id="district">
                            <option value="" selected="null" hidden disabled="">-Quận Huyện-</option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" name="school_name" type="text" placeholder="Tên trường">
                    </div>
                </div>
