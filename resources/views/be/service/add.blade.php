...
<div class="col-md-12">
    <div class="ibox">
        ...
        <div class="ibox-body">
            <form action="{{route('service_store')}}" method="post" enctype="multipart/form-data" class="form-horizontal"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea id="content" rows="2" value="" name="content">Content</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Link video(nếu có)</label>
                    <div class="col-sm-10">
